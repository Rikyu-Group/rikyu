...
const cta = `<div class="cta">
    ...
    <div class="s">チェンマイ・ナイトバザール3F ジャパニーズ ウェルネスラウンジ「利休」— 2026年開業準備中</div>
    <div class="row"><a class="main" href="https://line.me/R/ti/p/@rikyu" target="_blank" rel="noopener">まずは一見から — 500 THB</a><a class="ghost" href="/">公式サイトへ</a></div>
  </div>`;
const footer = `<footer>
