...
const cta = `<div class="cta">
    ...
    <div class="s">チェンマイ・ナイトバザール3F（予定）ジャパニーズ ウェルネスラウンジ「利休」— <span class="nowrap">2027年上旬 開業予定</span></div>
    <div class="row"><a class="main" href="/line/">先行案内を受け取る</a><a class="ghost" href="/">トップページへ</a></div>
  </div>`;
const footer = `<footer>
