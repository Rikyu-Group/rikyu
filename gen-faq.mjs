...
const QA = {
  ja: [
    ...
    ['何がありますか？',
     'フィンランド式サウナ（4〜6名・二段）、アイスバス、ととのいの間、コーヒーやスムージーと軽食のラウンジ、ビリヤードや将棋・ボードゲーム、畳のVIP和室、電源とWi-Fiの仕事場。延床約180㎡・5区画です。'],
    ['営業時間は決まっていますか？',
    ...
    ['オンラインコミュニティでは何をしますか？',
     '会員が参加できるオンラインの場です。朝活サウナ・瞑想・茶会・日本文化体験・交流会・AI勉強会などの催しを、ここから<span class="nowrap">生み出していきます。</span>'],
    ['開業はいつですか？',
  ...
  en: [
    ...
    ['What is inside?',
     'A Finnish sauna (4–6 people, two tiers), ice baths, a cool-down room, a lounge with coffee, smoothies and light meals, billiards, shogi and board games, a tatami VIP room, and a workspace with power and Wi-Fi. About 180 sqm in five zones.'],
    ...
    ['What happens in the online community?',
     'An online space for members. Morning sauna, meditation, tea gatherings, Japanese culture nights, meetups and AI study groups all start here.'],
    ['When do you open?',
  ...
  zh: [
    ...
    ['有什么设施？',
     '芬兰式桑拿（4〜6人・两层座）、冰浴、休整间、提供咖啡・冰沙・轻食的休息区、台球与将棋・桌游、榻榻米VIP和室、带电源和Wi-Fi的工作区。总面积约180㎡、共5个区域。'],
    ['营业时间定了吗？',
    ...
    ['线上社区做什么？',
     '这是会员参与的线上空间。晨间桑拿、冥想、茶会、日本文化体验、交流会、AI学习会等活动都从这里发起。'],
    ['什么时候开业？',
  ...
  ko: [
    ...
    ['어떤 시설이 있나요?',
     '핀란드식 사우나(4〜6명・2단), 아이스 바스, 휴식 공간, 커피와 스무디・간단한 식사가 있는 라운지, 당구와 쇼기・보드게임, 다다미 VIP 룸, 전원과 Wi-Fi가 있는 업무 공간. 약 180㎡・5개 구역입니다.'],
    ['영업시간은 정해져 있나요?',
    ...
    ['온라인 커뮤니티에서는 무엇을 하나요?',
     '회원이 참여하는 온라인 공간입니다. 아침 사우나・명상・다회・일본 문화 체험・교류회・AI 스터디 등의 모임이 여기서 시작됩니다.'],
    ['오픈은 언제인가요?',
  ...
  th: [
    ...
    ['มีอะไรบ้าง?',
     'ซาวน่าแบบฟินแลนด์ (4–6 คน สองชั้น) อ่างน้ำแข็ง พื้นที่พักผ่อน เลานจ์กาแฟ สมูทตี้และอาหารเบา ๆ บิลเลียด โชกิและบอร์ดเกม ห้องเสื่อทาทามิ VIP และพื้นที่ทำงานพร้อมปลั๊กไฟและ Wi-Fi รวมประมาณ 180 ตร.ม. 5 โซน'],
    ...
    ['คอมมูนิตี้ออนไลน์ทำอะไร?',
     'พื้นที่ออนไลน์สำหรับสมาชิก ซาวน่ายามเช้า สมาธิ พิธีชงชา วัฒนธรรมญี่ปุ่น มีตอัพ และเวิร์กช็อป AI <span class="nowrap">เริ่มต้นจากที่นี่</span>'],
    ['เปิดเมื่อไหร่?',
