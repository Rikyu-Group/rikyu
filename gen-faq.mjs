...
const QA = [
  ['会員でなくても利用できますか？',
   'できます。ドロップインは一回500THB、どなたでも利用できます（要予約）。気に入ったら回数券（五回2,000THB・十回3,600THB）へ。月額会員（3,500THB・使い放題）のみ、ご紹介制です。'],
  ['予約は必要ですか？',
   'はい、ご利用は予約制です。ご予約・お問い合わせは公式LINEからどうぞ。'],
  ['紹介者がいないのですが、会員になれますか？',
   'まずはドロップインでお越しください。場で生まれた縁が、そのまま紹介になります。'],
  ['何がありますか？',
  ...
  ['お酒は飲めますか？',
   'サウナまわりはノンアルコールです。VIP和室（予約制・商談や会食に）ではお楽しみいただけます。'],
  ['場所はどこですか？',
   'タイ・チェンマイ、ナイトバザールの三階です。表通りに看板は出していません。「雑踏の上にある」ことが、この場所の価値だと考えています。'],
  ['オンラインコミュニティでは何をしますか？',
   '会員が参加できるオンラインの場です。リトリートや月釜などの催しを、ここから<span class="nowrap">生み出していきます。</span>'],
  ['開業はいつですか？',
   '2026年を予定しています。準備の様子は読みもの「利休ノウナイ」で発信しています。'],
];
