...
const QA = {
  ja: [
    ...
    ['オンラインコミュニティでは何をしますか？',
     '会員が参加できるオンラインの場です。朝活サウナ・瞑想・茶会・日本文化体験・交流会などの催しを、ここから<span class="nowrap">生み出していきます。</span>'],
    ['開業はいつですか？',
  ...
  en: [
    ...
    ['What happens in the online community?',
     'An online space for members. Morning sauna, meditation, tea gatherings, Japanese culture nights and meetups all start here.'],
    ['When do you open?',
  ...
  zh: [
    ...
    ['线上社区做什么？',
     '这是会员参与的线上空间。晨间桑拿、冥想、茶会、日本文化体验、交流会等活动都从这里发起。'],
    ['什么时候开业？',
  ...
  ko: [
    ...
    ['온라인 커뮤니티에서는 무엇을 하나요?',
     '회원이 참여하는 온라인 공간입니다. 아침 사우나・명상・다회・일본 문화 체험・교류회 등의 모임이 여기서 시작됩니다.'],
    ['오픈은 언제인가요?',
  ...
  th: [
    ...
    ['คอมมูนิตี้ออนไลน์ทำอะไร?',
     'พื้นที่ออนไลน์สำหรับสมาชิก ซาวน่ายามเช้า สมาธิ พิธีชงชา วัฒนธรรมญี่ปุ่น และมีตอัพ <span class="nowrap">เริ่มต้นจากที่นี่</span>'],
    ['เปิดเมื่อไหร่?',
